...
# maintainer
OF_MAINTAINER := Mahdi_Asghari

# screen settings (1220 x 2712)
OF_SCREEN_H := 2712
OF_STATUS_H := 87
OF_HIDE_NOTCH := 1
...
# must match BOARD_MAIN_SIZE in BoardConfig.mk
OF_DYNAMIC_FULL_SIZE := 9122611200

# Iran does not observe DST
OF_DEFAULT_TIMEZONE := IRST-3:30
...
# default keymaster
# (crypto is disabled in BoardConfig.mk - uncomment together with it)
